...
class RoutePlanner:
    ...
    def _rebalance_label_gap(
        ...
        # Compute TU proportions by label across the whole plan
        ...
        # Normalized target from preferences
        ...
        # Find largest positive gap and most negative gap
        ...
        generated = 0
        # Precompute used IDs outside each day
        ...
        for idx, day in enumerate(plan):
            ...
            # Candidates to remove: POIs of source_label in this day, high TU first
            ...
            for rem in removable:
                ...
                for add in add_candidates:
                    ...
                    # avoid adding duplicate within the day
